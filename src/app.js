const bcLocations = [
...

    {
        ...
        coins: [
            ...
            { collected: false, desc: "Fruit Exchange: Banana lady is waiting beside the canal, give her 3x bananas", },
            { collected: false, desc: "Fruit Exchange: Pineapple lady is to the right of the Shine Gate, give her 3x pineapples", },
            { collected: false, desc: "Fruit Exchange: Durian lady is to the left of the Shine Gate, you must kick 3x durians accross the canal to get them to her", },
            { collected: false, desc: "Fruit Exchange: Coconut lady is on an island to the west who wants 3x coconuts. These grow on the tree on the island.", },
            { collected: false, desc: "Blue Bird #1: Usually on or flying around the roof near the Sirena Beach entrance behind the Pianta statue", },
            { collected: false, desc: "Blue Bird #2: Usually on or flying around the roof to the left of the Shine Gate", },
            ...
            { collected: false, desc: "Use Yoshi to spray the orange goo off the window above the roof near the lighthouse", },
            { collected: false, desc: "Use Yoshi to spray the orange goo off the tower near the Pinna Park cannon", },
...

    {
        ...
        coins: [
            ...
            { collected: false, desc: "In the air above the water near the red flags across from the scaffolding", },
            ...
            { collected: false, desc: "Graffiti X: On the side of Ricco Tower. TIP: Use Turbo Nozzle or belly slides in the tunnel back to the market", },
            { collected: false, desc: "Graffiti X: On the front of the building near the Market on the far side of the harbor. TIP: use Turbo Nozzle", },
            ...
            { collected: false, desc: "Episode 1 only: Spray the propeller to raise the yellow submarine all the way", },
            { collected: false, desc: "Episode 2 only: Above the water in the trail of coins leading to the Blooper race", },
            { collected: false, desc: "Episode 3 and after: Defeat Boat Spider #1: Defeat the spiders crawling inside cage on the ship", },
            { collected: false, desc: "Episode 3 and after: Defeat Boat Spider #2: There are two spiders (a third in some episodes but the third does not drop anything)", },
            { collected: false, desc: "Episode 4 and after: Defeat the Blooper inside the big yellow cage that held the Shine Sprite in Episode 3", },
            { collected: false, desc: "Episode 6 and after: Spray the fish baskets in the middle of the fish market area", },
            { collected: false, desc: "Episode 8: Use Yoshi to eat the spider crawling on the wall near Ricco Tower", },
...

    {
        name: "Gelato Beach",
        coins: [
            { collected: false, desc: "On the island with the palm trees, on top of the tallest tree with the swing", },
            ...
            { collected: false, desc: "In the water beneath the deck behind the surf/blender cabana", },
            { collected: false, desc: "Between a rocky crag up the hill on the far side of the beach near the surf/blender cabana", },
            { collected: false, desc: "On top of one of the posts holding up the bouncy wires in the upper area near the amphitheater", },
            { collected: false, desc: "Above the rocky crag on On top of the highest bouncy wire, as part of a stack of coins", },
            { collected: false, desc: "Blue bird #1: Spray the blue bird flying around the amphitheater", },
            { collected: false, desc: "Blue bird #2: Spray the blue bird flying around the amphitheater", },
            { collected: false, desc: "Hovering high above a tower near the solar panels", },
            { collected: false, desc: "Drop a fruit into the blender from the roof of the surf/blender cabana", },
            { collected: false, desc: "Graffiti M: On a wall of a ledge with a ring of 6 golden coins near the roof of the sand cabana", },
            { collected: false, desc: "Graffiti triangle: On a cliff face on the opposite end of the beach. TIP: use wet belly slide or Turbo Nozzle", },
            { collected: false, desc: "Graffiti triangle: On a cliff face on the end of the beach. TIP: use wet belly slide or Turbo Nozzle", },
            ...
            { collected: false, desc: "All episodes except 3 and 5: Under water in a school of fish around the palm tree island", },
            { collected: false, desc: "All episodes except 3 and 5: Under water in a school of fish near the red coin reef", },
            { collected: false, desc: "All episodes except 3: Blue coin shine #1: Spray the sand near the sand cabana surf boards until you see sparks indicating something in the sand. Spray to reveal a Blue Shine icon and a Blue Coin", },
            { collected: false, desc: "All episodes except 3: Blue coin shine #2: Spray the sane on the main beach to the left of the peninsula", },
            { collected: false, desc: "All episodes except 3: Blue coin shine #3: Spray the sand on the beach to the right near the catamaran when you leave the surf/blender cabana", },
            { collected: false, desc: "All episodes except 3 and 5: Blue coin shine #4: Spray the sand in the middle of the peninsula", },
            ...
            { collected: false, desc: "Episode 4 only: Sand Bird blue coin #1: On a cloud above the birds left wing when the level starts. The bird will circle infinitely, so as long as you don't fall off, you can keep riding it until you get them all.", },
            { collected: false, desc: "Episode 4 only: Sand Bird blue coin #2: On a cloud toward the middle of the bird after a 1-up mushroom. All are on clouds that float by during the level. The bird will circle infinitely, so as long as you don't fall off, you can keep riding it until you get them all.", },
            { collected: false, desc: "Episode 4 only: Sand Bird blue coin #3: On a cloud toward the middle of the bird as starts to bank left. All are on clouds that float by during the level. The bird will circle infinitely, so as long as you don't fall off, you can keep riding it until you get them all.", },
            { collected: false, desc: "Episode 4 only: Sand Bird blue coin #4: On a cloud above the birds right wing at the top of the level. All are on clouds that float by during the level. The bird will circle infinitely, so as long as you don't fall off, you can keep riding it until you get them all.", },
            { collected: false, desc: "Episode 5 and after: Spray the lone blue cataquack sleeping in a tree near the base of the Sun Tower, then bounce on him for the coin", },
...

    {
        ...
        coins: [
            ...
            // TODO: validate if this is still here
            // { collected: false, desc: "On the beach, spray the sand on the side with the cannon until you see sparkles, indicating something there. Spray the spot for a Blue Shine icon and a Blue Coin. There are two total.", },
            { collected: false, desc: "Episode 2 only: Basket coin #1: Use the purple Bullet Bills to blow up the baskets scattered around the beach", },
            { collected: false, desc: "Episode 2 only: Basket coin #2: Use the purple Bullet Bills to blow up the baskets scattered around the beach", },
            { collected: false, desc: "Episode 2 only: Basket coin #3: Use the purple Bullet Bills to blow up the baskets scattered around the beach", },
            { collected: false, desc: "Episode 2 only: Basket coin #4: Use the purple Bullet Bills to blow up the baskets scattered around the beach", },
            { collected: false, desc: "Episode 2 only: Basket coin #5: Use the purple Bullet Bills to blow up the baskets scattered around the beach", },
            { collected: false, desc: "Episode 2 only: Basket coin #6: Use the purple Bullet Bills to blow up the baskets scattered around the beach", },
            ...
            { collected: false, desc: "All episodes except 2 and 4: Blue bird #1 flying around the park. Spray them it a Blue Coin.", },
            { collected: false, desc: "All episodes except 2 and 4: Blue bird #2 flying around the park. Spray them it a Blue Coin.", },
            ...
            { collected: false, desc: "All episodes except 2 and 4: O Graffiti: On top of the Ferris wheel", },
    ...
    {
        name: "Noki Bay",
        note: 'All of these coins can be collected in Episode 6.<br><br>Noky Bay is complicated, so just use 360Chrism\'s video for locations: <a href="https://www.youtube.com/watch?v=KESDX5VCVEE">YouTube</a>',
        coins: [
            ...
            { collected: false, desc: "Ruin coin #1: Spray the portion of the ruins that reveals a long, vertical passage. Wall kick up the very top, then head left through the hidden passage. At the end, hover around the side of the cliff down and to the right to see two Blue Coins in two alcoves on the wall.", },
            { collected: false, desc: "Ruin coin #2: Spray the portion of the ruins that reveals a long, vertical passage. Wall kick up the very top, then head left through the hidden passage. At the end, hover around the side of the cliff down and to the right to see two Blue Coins in two alcoves on the wall.", },
...

    {
        ...
        coins: [
            ...
            { collected: false, desc: "Episode 5 only: Beehive #1: Use Yoshi to spray the beehives in town and eat all the bees", },
            { collected: false, desc: "Episode 5 only: Beehive #2: Use Yoshi to spray the beehives in town and eat all the bees", },
            { collected: false, desc: "Episode 5 only: Use Yoshi to eat all the butterflies on top of a mushroom in the topside of the village -- the last will give you a Blue Coin.", },
            { collected: false, desc: "Episode 6 only: Save all ten villagers before time runs out, then talk to each of the adult villagers who will give you a blue coin. The eight adult villagers you rescue during this level will give you a Blue Coin apiece if you talk to them again afterward (the kids give you nothing).", },
            { collected: false, desc: "Episode 8 only: Blue Bird #1: Spray the blue bird flying around the village", },
...

    {
        ...
        coins: [
            { collected: false, desc: "Coin #1: on the first platform passed the spike and fire platforms", },
            { collected: false, desc: "Coin #2: around the platformat at the end of lava river", },
            { collected: false, desc: "Coin #3: around the platformat at the end of lava river", },
            { collected: false, desc: "Coin #4: around the platformat at the end of lava river", },
            { collected: false, desc: "Coin #5: around the platformat at the end of lava river", },
            { collected: false, desc: "Coin #6: around the platformat at the end of lava river", },
            { collected: false, desc: "Coin #7: around the platformat at the end of lava river", },
            { collected: false, desc: "Coin #8: around the platformat at the end of lava river", },
            { collected: false, desc: "Coin #9: around the platformat at the end of lava river", },
            { collected: false, desc: "Coin #10: around the platformat at the end of lava river", },
        ]
    },
]
